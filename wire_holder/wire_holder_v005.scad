...
// Wall height = gusset_height + overhang_thickness
...
// Wall dimensions
wall_thickness = 2;
wall_height = gusset_height + overhang_thickness;
...
difference() {
    union() {
        ...
        // Wall between left gussets
        translate([0, overhang_length, -gusset_height])
            cube([overhang_width, wall_thickness, wall_height]);

        // Wall between right gussets
